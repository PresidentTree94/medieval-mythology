      ...
      <article>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="mt-12 grid grid-cols-4 gap-6">
            {deities.map(d => (
              <div key={d.id} className="border border-[oklch(0.50_0.120_76)]/30 hover:border-[oklch(0.72_0.150_80)] rounded-lg p-6 text-center group">
                <div className="relative aspect-square w-full max-w-32 rounded-full overflow-hidden mx-auto mb-4 border-2 border-[oklch(0.72_0.150_80)]/40 bg-background-dark">
                  <Image src="/god.jpg" alt="God" fill sizes="100%" className="object-cover object-top" />
                </div>
                <h3 className="text-card text-xl">{d.epithet}</h3>
                <div className="mt-2 flex flex-wrap gap-1.5 justify-center font-display uppercase tracking-widest text-xs">
