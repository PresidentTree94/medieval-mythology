...
const stats = [
  { label: "Greek", text: "Greek" },
  { label: "Medieval", text: "Medieval" },
      ...
      <article>
        <div>
          ...
          <div className="space-y-8 mt-14">
            <div className="card flex flex-col lg:flex-row group">
              ...
              <div className="p-8 md:p-10 lg:w-1/2">
                ...
                <h3 className="text-3xl md:text-4xl text-foreground-dark my-2">Title</h3>
            ...
            <div className="card flex flex-col lg:flex-row-reverse group">
              <div className="relative h-72 lg:h-auto lg:w-1/2 overflow-hidden">
                <Image src="/landscape.jpg" alt="Landscape" fill sizes="100%" className="object-cover object-top group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="p-8 md:p-10 lg:w-1/2">
